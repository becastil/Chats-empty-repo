...
refreshed on 2026-07-18 at 02:42 UTC. The outreach draft report was captured on
...
- 48 stable releases, all satisfying their version-aware artifact contracts.
- 201 cumulative primary artifact requests: 28 portable and 173 wheel.
- 163 manifest requests, 31 source requests, and 0 unknown requests.
- 11 additional primary artifact requests since the prior checkpoint: 3
  portable and 8 wheel. The new `v0.3.44` release accounts for 7 requests,
  while `v0.3.43` gained 4 wheel requests.
