...
def _release_export(
    *,
    ...
    assets = [
        {"name": "repo-scout-0.3.50.pyz", "download_count": portable},
        {
            "name": "repo_scout-0.3.50-py3-none-any.whl",
            "download_count": wheel,
        },
        {"name": "repo_scout-0.3.50.tar.gz", "download_count": 1},
    ...
    return [
        {
            ...
            "html_url": "https://example.invalid/releases/v0.3.50",
            "assets": assets,
        }
    ]
