...
```bash
python3 -m pip install https://github.com/becastil/Chats-empty-repo/releases/download/v0.3.49/repo_scout-0.3.49-py3-none-any.whl
...
evidence, and a downloadable schema-2 rollout bundle. It installs the `v0.3.49`
