...
class ReleaseManifestTests(unittest.TestCase):
    ...
    def test_site_deployment_handoff_preserves_publication_boundary(self) -> None:
        ...
        for requirement in (
            ...
            "resolved dependency metadata to the configured npm audit "
            "endpoint",
            "explicitly authorized for that disclosure",
            "`dependency audit did not complete cleanly`",
            "no candidate is produced",
            "candidate approval remains blocked",
            "lint, build, site tests, packaging, receipt publication",
            "Do not skip, omit, or weaken the audit",
            "malformed or mismatched package/site release versions",
            "`project.version` in `pyproject.toml`",
            "website's single",
            "`RELEASE_VERSION` declaration",
            "schema-5 receipt records the public release",
            ...
            "filesystem identity of any non-symlink repository directory",
            ...
            "prefix is followed by one compact JSON object",
            "Parse that object rather than splitting its contents on spaces",
            "repository URLs containing raw whitespace fail closed",
            "Percent-encode any legitimate URL path space",
            "without querying a remote ref",
            "Request output is not consent",
    ...
    def test_policy_activation_smoke_contract_passes_against_source(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                "oversized-bootstrap-receipt-rejected",
    ...
    def test_pilot_funnel_smoke_contract_passes_against_source(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                "unsafe-distribution-asset-name-rejected",
