...
```bash
curl -fL https://github.com/becastil/Chats-empty-repo/releases/download/v0.3.46/repo-scout-0.3.46.pyz -o /tmp/repo-scout.pyz
...
```bash
gh release download v0.3.46 \
  --repo becastil/Chats-empty-repo \
  --pattern "repo_scout-*" \
  --pattern "repo-scout-*.pyz" \
  --pattern SHA256SUMS
python3 -m pip install ./repo_scout-0.3.46-py3-none-any.whl
```
...
gh attestation verify repo-scout-0.3.46.pyz \
  --repo becastil/Chats-empty-repo
gh attestation verify repo_scout-0.3.46-py3-none-any.whl \
  --repo becastil/Chats-empty-repo
gh attestation verify repo_scout-0.3.46.tar.gz \
  --repo becastil/Chats-empty-repo
```
