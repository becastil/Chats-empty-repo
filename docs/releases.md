...
gh release download v0.3.11 \
  ...
  --pattern SHA256SUMS
python3 -m pip install ./repo_scout-0.3.11-py3-none-any.whl
```
...
gh attestation verify repo-scout-0.3.11.pyz \
  --repo becastil/Chats-empty-repo
gh attestation verify repo_scout-0.3.11-py3-none-any.whl \
  --repo becastil/Chats-empty-repo
gh attestation verify repo_scout-0.3.11.tar.gz \
  --repo becastil/Chats-empty-repo
```
