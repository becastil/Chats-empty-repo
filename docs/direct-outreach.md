...
repeated, or negated price text, explicit language anywhere in the draft saying
the recipient will not pay or no payment is required, and any competing dollar
amount fail at the same boundary. An approved message can therefore test
willingness to pay for the stated offer instead of an undisclosed or
contradictory price.
