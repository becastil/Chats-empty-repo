...
`outreach-private/` directory. Its current eleven-column shape retains outcome
observation dates and approved review identity, while legacy nine- and
ten-column ledgers remain readable without inventing missing history. The
ledger uses prospect aliases and records
